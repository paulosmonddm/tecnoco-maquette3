$( document ).ready(function() {
  ...
  $('#asesoria-profesional').click(function() {
    $([document.documentElement, document.body]).animate({
      scrollTop: $('[data-name="Asesoria profesional"]').offset().top - 100
    }, 400);
  })
  $('#soluciones-efectivas').click(function() {
    $([document.documentElement, document.body]).animate({
      scrollTop: $('[data-name="Soluciones efectivas"]').offset().top - 100
    }, 400);
  })
  $('#servicio-sobresaliente').click(function() {
    $([document.documentElement, document.body]).animate({
      scrollTop: $('[data-name="Servicio sobresaliente"]').offset().top - 100
    }, 400);
  })
